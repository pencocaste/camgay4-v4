...
export function MenHairyDescription() {
  ...
  const description = `Discover our collection of hairy male models on CamGay4. Watch live shows featuring performers who embrace their natural look. Join their rooms to appreciate authentic beauty and engaging personalities.`;
